    ...
    <div className="p-4 bg-white shadow-md">
        <ul className="space-y-4">
            <li className="flex items-center space-x-4">
                ...
                <div>
                <h3 className="font-bold">New Budget Bill</h3>
            ...
            <li className="flex items-center space-x-4">
                ...
                <div>
                    <h3 className="font-bold">Budget Bill</h3>
                    <p className="text-gray-600">Speak directly to your customers</p>
                </div>
            </li>
            <li className="flex items-center space-x-4">
                <div className="p-2 bg-gray-100 rounded-full">
                ...
                <div>
                    <h3 className="font-bold">Household Accounts</h3>
                    <p className="text-gray-600">Your customers' data will be safe and secure</p>
                </div>
            </li>
            <li className="flex items-center space-x-4">
                <div className="p-2 bg-gray-100 rounded-full">
                ...
                <div>
                    ...
                    <p className="text-gray-600">Connect with third-party tools</p>
                </div>
            </li>
        </ul>
    </div>
